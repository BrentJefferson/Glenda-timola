      ...
      <div className="max-w-6xl mx-auto px-6 relative scroll-reveal">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featured.map((item, i) => (
            <div
              key={item.id}
              className="group rounded-xl overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 scroll-reveal"
